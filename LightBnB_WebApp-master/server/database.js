...
const getAllProperties = function(options, limit = 10) {
  ...
  if (options.city) {
    ...
    queryString += `${queryParams === 1 ? 'WHERE' : 'AND'} city LIKE $${queryParams.length} `;
  }
...
const addProperty = function(property) {
  const queryString = `INSERT INTO properties (owner_id, title, description, thumbnail_photo_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, city, street, province, post_code 
